#!/usr/bin/env python2
# -*- coding: utf8 -*-
#Domain header check is a quick
#tool thats sole purpose is to take
#a list of subdomains and then to
#return the title out of the subdomain
#it is meant to be used along with Sublister
#OR any other domain enumeration tool
...
def output_file_init(n, m):
    ...
    info ("Give me urls and I will return contents of website titles for you!")	
...
if __name__ == "__main__":
    ...
    args = parse_args()
    if not args.domain:
        sys.exit('[!] Enter domain to check please: ./domain_check.py -d "test.org"')
